...
CREATE TABLE IF NOT EXISTS airport (
	...
	airport_iata_code_id BIGINT REFERENCES airport_iata_code(airport_iata_code_id) UNIQUE,
	airport_icao_code_id BIGINT REFERENCES airport_icao_code(airport_icao_code_id) UNIQUE,
...
GRANT USAGE, SELECT ON SEQUENCE flightroute_callsign_inner_flightroute_callsign_inner_id_seq TO adsbdb;

CREATE INDEX flightroute_callsign_inner_index ON flightroute_callsign_inner(callsign);
