...
GRANT USAGE, SELECT ON SEQUENCE airline_airline_id_seq TO adsbdb;
...
GRANT USAGE, SELECT ON SEQUENCE flightroute_callsign_inner_te_flightroute_callsign_inner_te_seq TO adsbdb;
...
CREATE TABLE IF NOT EXISTS flightroute_callsign (
	...
	iata_suffix_id BIGINT REFERENCES flightroute_callsign_inner(flightroute_callsign_inner_id),
	icao_suffix_id BIGINT REFERENCES flightroute_callsign_inner(flightroute_callsign_inner_id),
...
-- ALTER TABLE flightroute_callsign RENAME CONSTRAINT flightroute_callsign_temp_iata_suffix_id_fkey TO flightroute_callsign_iata_suffix_id_fkey;
-- ALTER TABLE flightroute_callsign RENAME CONSTRAINT flightroute_callsign_temp_icao_suffix_id_fkey TO flightroute_callsign_icao_suffix_id_fkey;
