...
-- TODO this is broken?
-- \echo "Change from bigserial to bigint"
-- ALTER TABLE incoming_request ALTER COLUMN incoming_request_id DROP DEFAULT;
-- DROP SEQUENCE IF EXISTS incoming_request_incoming_request_id_seq;
-- ALTER TABLE incoming_request ALTER COLUMN incoming_request_id TYPE BIGINT;
-- ALTER TABLE incoming_request ALTER COLUMN incoming_request_id ADD GENERATED BY DEFAULT AS IDENTITY (START WITH 1);
-- ALTER TABLE temp_incoming_request ALTER COLUMN temp_incoming_request_id DROP DEFAULT;
-- DROP SEQUENCE IF EXISTS temp_incoming_request_temp_incoming_request_id_seq;
-- ALTER TABLE temp_incoming_request ALTER COLUMN temp_incoming_request_id TYPE BIGINT;
-- ALTER TABLE temp_incoming_request ALTER COLUMN temp_incoming_request_id ADD GENERATED BY DEFAULT AS IDENTITY (START WITH 1);
-- ALTER TABLE incoming_request_url ALTER COLUMN incoming_request_url_id DROP DEFAULT;
-- DROP SEQUENCE IF EXISTS incoming_request_url_incoming_request_url_id_seq;
-- ALTER TABLE incoming_request_url ALTER COLUMN incoming_request_url_id TYPE BIGINT;
-- ALTER TABLE incoming_request_url ALTER COLUMN incoming_request_url_id ADD GENERATED BY DEFAULT AS IDENTITY (START WITH 1);
...
ADD CONSTRAINT uq_incoming_request_url_parts
